...
namespace MF.Rb.Api.Controllers.V1
{
    ...
    public class ReportsController : ControllerBase
    {
        ...
        [HttpGet("{reportId}", Name = nameof(GetByIdV1))]
        public IActionResult GetByIdV1(int reportId)
        {
        ...
        public IActionResult Post([FromBody] Report report)
        {
            ...
            string name = nameof(GetByIdV1);
           
            return CreatedAtRoute(nameof(GetByIdV1), new { reportId = report.Id }, report );
